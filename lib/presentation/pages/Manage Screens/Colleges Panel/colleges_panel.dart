...
// Function to open the batch dialog (reusable for opening the dialog)
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 25.0, top: 25, bottom: 15),
                            child: Text(
                              'Manage Batches for $collegeName',
  ...
  Widget _desc() {
    if (MediaQuery.of(context).size.width < 600) {
      ...
      // Desktop view - you can use the original table or more detailed design for larger screens
      return Text(
  ...
  Widget _buildCollegeTableMobile() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('State: ${college['state']}, City: ${college['city']}'),
                  ButtonBar(
                    children: [
                      TextButton(
                        onPressed: () {
  ...
  // Build UI based on screen size (desktop or mobile)
  Widget _buildContent() {
    if (MediaQuery.of(context).size.width < 600) {
      // Mobile view
      return _buildCollegeTableMobile();
    } else {
      // Desktop view - you can use the original table or more detailed design for larger screens
      return _buildCollegeTableDesktop();
    }
  }

  Widget _buildCollegeTableDesktop() {
    return SingleChildScrollView(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: colleges.map((college) {
